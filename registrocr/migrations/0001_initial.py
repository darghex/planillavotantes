    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombres', models.CharField(max_length=40)),
                ('apellidos', models.CharField(max_length=40)),
                ('documento', models.IntegerField(unique=True, validators=[django.core.validators.RegexValidator(regex=b'^\\d{10}$', message=b'Documento no es correcto', code=b'Invalid number')])),
                ...
                ('telefono', models.IntegerField(unique=True, validators=[django.core.validators.RegexValidator(regex=b'^\\d{10}$', message=b'Documento no es correcto', code=b'Invalid number')])),
